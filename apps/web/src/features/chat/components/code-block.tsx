...
export function CodeBlock({ language, value, children }: CodeBlockProps) {
  ...
  return (
    <div className="group relative my-4 overflow-hidden rounded-xl border border-border bg-[#1e1f20] shadow-sm transition-all hover:shadow-md hover:border-primary/20 glow-hover">
